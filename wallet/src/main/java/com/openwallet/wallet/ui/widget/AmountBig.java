 ...
 */
public class AmountBig extends LinearLayout {
...
//    private final TextView amountPending;
    ...
    public AmountBig(Context context, AttributeSet attrs) {
        super(context, attrs);

        LayoutInflater.from(context).inflate(R.layout.amount_big, this, true);
...
//        amountPending.setVisibility(GONE);
        ...
        if (!getRootView().isInEditMode()) {
            if (isBig) {
                ...
                symbolView.setTextAppearance(context, R.style.AmountBSymbolBig);
            } else if (isSmall) {
                amountView.setTextAppearance(context, R.style.AmountSmall);
                symbolView.setTextAppearance(context, R.style.AmountBSymbolSmall);
            } else {
                amountView.setTextAppearance(context, R.style.Amount);
                symbolView.setTextAppearance(context, R.style.AmountBSymbol);
            }
        }
