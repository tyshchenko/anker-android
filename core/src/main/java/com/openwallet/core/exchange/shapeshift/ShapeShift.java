package com.openwallet.core.exchange.shapeshift;
...
import com.openwallet.core.exchange.shapeshift.data.ShapeShiftCoins;
import com.openwallet.core.exchange.shapeshift.data.ShapeShiftEmail;
import com.openwallet.core.exchange.shapeshift.data.ShapeShiftException;
import com.openwallet.core.exchange.shapeshift.data.ShapeShiftLimit;
...
import com.openwallet.core.exchange.shapeshift.data.ShapeShiftRate;
import com.openwallet.core.exchange.shapeshift.data.ShapeShiftTime;
import com.openwallet.core.exchange.shapeshift.data.ShapeShiftTxStatus;
...
public class ShapeShift extends Connection {
    ...
    private String apiPublicKey = "a6cdaf4a4286c4b9c25a3152aaaa41efea0ed0e412e547a77083f2643faac4950d2c7b6f317193e18625170ae265e1df4424f52159837ec6121f11fff01c7c50";
